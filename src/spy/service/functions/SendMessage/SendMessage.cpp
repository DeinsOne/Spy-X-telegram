...
void spy::service::functions::SendMessage::SendMarkdown() {
...
void spy::service::functions::SendMessage::SendHtml() {
    auto textParseHtml = td::td_api::make_object<td::td_api::textParseModeHTML>();
    auto parseTextEntities = td::td_api::make_object<td::td_api::parseTextEntities>(message_, std::move(textParseHtml));
