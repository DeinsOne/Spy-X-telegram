...
#ifndef spy_DeletedContentChatSetIncludedChatsCommand
#define spy_DeletedContentChatSetIncludedChatsCommand
...
namespace spy { namespace service { namespace controller { namespace command {
    ...
    class SetIncludedChatsCommand : public ICommand {
    public:
        ...
        static std::shared_ptr<ICommand> makeCommand(
            ...
            return std::make_shared<SetIncludedChatsCommand>(tdHandler, controllerHandler);
        }

        SetIncludedChatsCommand(
            const std::shared_ptr<tdlpp::base::TdlppHandler>& tdHandler,
            const std::shared_ptr<ControllersHandler>& controllerHandler
        );
    ...
    public:
        ...
        static const std::int64_t ID = 879307;
        virtual std::int64_t get_id() { return SetIncludedChatsCommand::ID; };

    private:
        void sendProposition();
        void sendSuccessMessage();
        bool setIncludedChats(const std::string& argument);
...
#endif // spy_DeletedContentChatSetIncludedChatsCommand
